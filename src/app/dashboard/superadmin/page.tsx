                                                ...
                                                <div>
                                                    ...
                                                    <div className="flex gap-2">
                                                        <input 
                                                            ...
                                                            defaultValue={shop.deeplink_path || ''}
                                                            onBlur={(e) => handleUpdateDeeplink(shop.id, e.target.value)}
                                                        />
                                                        <button className="bg-indigo-600 p-2 rounded-xl" title="Click để thử link"><ExternalLink size={14}/></button>
                                                    </div>
